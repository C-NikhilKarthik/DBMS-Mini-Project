...
function Status({ data }) {
    return (
        <div className='w-full flex items-center pt-28 px-4 flex-col gap-8 bg-[url("https://wallpaperaccess.com/full/1126753.jpg")] h-full bg-cover bg-scroll bg-center'>
            <Navbar />
            <div className='flex w-full md:w-5/6 xl:w-2/3 flex-col bg-[#08192ea0] backdrop-blur-md rounded'>
            ...
            <div className='flex w-full md:w-5/6 xl:w-2/3 flex-col bg-[#08192ea0] backdrop-blur-md rounded'>
                ...
                <div className='h-[20rem] gap-6 w-full flex flex-col'>
                    <div className="flex items-center w-full justify-between p-4 text-slate-300">
                        <div className="flex items-center gap-4">
                            <div>Enter the Client Number </div>
